                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Listado de Empleados</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-b-0 px-3">
                ...
                <h1 class="m-b-0">Listado de Empleados</h1>
                
            </div>
               <div>
                  <br>
                  <a type="button" class="btn btn-primary float-right mr-5" href="./empleado.jsp">Agregar Empleado</a>
              </div>
                  ...
                  <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    <table class="table table-borderless table-stripped table-earning">
                                        ...
                                        for (Empleado empleado : listaEmpleados) {
                                            ...
                                            String fechaComoCadena = fechaCorta.format(fecha);
                                            ...
                                            String nombreUsuario = empleado.getUsuario().getUsuario();
                                            String password = empleado.getUsuario().getPassword();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-data-feature section__content">
                                                        ...
                                                        <div class="pr-3"></div>    
                                                        <form name="frmEditarEmpleado" action="../SvModificarEmpleado" method="POST" style="display:inline">
                                                            <input type="hidden" name="id" value="<%=id%>" >
