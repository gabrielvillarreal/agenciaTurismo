      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Editar Servicio</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Editar Servicio</h6>
        </nav>
              ...
              <div class="card-body">
                  <form action="../SvEditarServicio" method="GET" >
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-10 mt-4 mb-0">Modificar</button>
                    </div>
                  </form>
                </div>
