                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="au-card">
                                    <div class="card-header ">
                                        <button type="button" class="btn btn-primary float-right m-2 mt-1"><i class="fas fa-edit"></i>&nbsp; Editar</button>
                                        <button type="button" class="btn btn-danger float-right m-2 mt-1"><i class="fas fa-trash-alt"></i>&nbsp; Borrar</button>
                                        <strong class="card-title text-dark ">Oliver Liam</strong>
                                        <br><br>
                                        </div>
                                    <div >
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <span class="mb-3 text-xs">Nombre de Servicio: <span class="text-dark ms-sm-2 font-weight-bold">Viking Burrito</span></span>
                                            </li>
                                            <li class="list-group-item">
                                                <span class="mb-2 text-xs">Destino: <span class="text-dark ms-sm-2 font-weight-bold">oliver@burrito.com</span></span>
                                            </li>
                                            <li class="list-group-item">
