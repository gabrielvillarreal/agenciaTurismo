  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="./listadoPaquetes.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Paquete Turistico</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Paquete Turistico</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Paquete Turistico</h6>
              </div>
            </div>
              <div class="card-body">
                  <div action="../SvPaquete" method="POST">
                      ...
                      <form action="agregarServicio" id="formularioServicio">
                        ...
                        <div class="mdl-selectfield mdl-js-selectfield mdl-selectfield--floating-label">
                            ...
                            <select class="mdl-selectfield__select" id="servicio" name="servicio">
                            <%
                            ...
                            <button type="submit" class="btn btn-sm bg-gradient-primary btn-sm w-10 mt-4 mb-4">Agregar Servicio</button>
                        </div>
                      </form>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-10 mt-4 mb-0">Aceptar</button>
                    </div>
                  </form>
                </div>
